...
function Header() {
  ...
  return (
    <header className={`flex justify-between items-center py-[18px] px-[20px] border-b-2 ${ display ? 'border-borderColorDark' : 'border-borderColor'} relative`}>
        ...
        <section className={`flex flex-col lg:flex-row items-start lg:py-0 py-16 lg:px-0 md:px-8 px-2 lg:items-center gap-5 absolute lg:relative h-screen lg:h-auto ${display ? 'bg-sidebarBgDark border-borderColorDark': 'bg-sidebarBg border-borderColor'} border-l-2 lg:border-l-0 lg:bg-transparent right-0 top-0 ${ nav ? 'md:w-1/2 w-full opacity-100 pointer-events-auto' : 'w-0 overflow-hidden lg:opacity-100 opacity-0 pointer-events-none'} lg:w-auto duration-300`}>
          ...
          <div className='flex lg:flex-row flex-col items-start lg:items-center gap-[20px] lg:w-auto w-full'>
            ...
            <div className={`cursor-pointer relative w-[40px] h-[40px] flex items-center justify-center rounded-full border-2 ${ display ? 'border-borderColorDark' : 'border-borderColor'} relative`} onClick={() => openNotif()}>
              ...
              <div className={`absolute top-[50px] left-0 ${ display ? 'bg-sidebarBgDark text-white' : 'bg-white text-text' } shadow-lg rounded-md py-2 px-3 w-[200px] h-[100px] flex items-center justify-center ${notif ? 'scale-100' : 'scale-0'} duration-200 z-40`}>
            ...
            <div className={`flex  items-center border-2 ${ display ? 'border-borderColorDark' : 'border-borderColor'} gap-4 p-1 rounded-full`}>
              <div className='flex items-center gap-3 justify-between relative'>
                ...
                <div className={`absolute top-[50px] left-0 ${ display ? 'bg-sidebarBgDark text-white' : 'bg-white text-text' } shadow-lg rounded-md py-2 px-3 w-[200px] ${menu ? 'scale-100' : 'scale-0'} duration-200 z-40`}>
                  <ul className='w-full'>
